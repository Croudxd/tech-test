...
public:
    ...
    const std::string& getInstrument() const override { return instrument_; }
    void setInstrument(const std::string& instrument) override { instrument_ = instrument; }
    
    const std::string& getCounterparty() const override { return counterparty_; }
    ...
    const std::string& getTradeType() const override = 0;
    const std::string& getTradeId() const override { return tradeId_; }
